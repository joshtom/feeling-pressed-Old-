        ...
        <div className="main" style={bgImage}> 
            <div className="container">
                ...
                <div className="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <p className="col-lg-8 col-md-6 col-sm-12"> "And it came to pass, that, as the people pressed upon Him to hear the word of GOD, he stood by the lake of Gennesaret" </p>
