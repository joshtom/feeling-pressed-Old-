                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-sm-12 no-gutters">
                        <div className="mission-card" id="card-1">
                            <header><span className="cube"></span>Purpose</header>
                            <article>
                                To inspire believers of Jesus, to walk a closer and exciting Journey with christ.
                            </article>
                            <Link to="/about#"> Read More <ArrowRightIcon /></Link>
                        </div>
                    </div>
                    <div className="col-lg-4 col-sm-12 no-gutters">
                        <div className="mission-card" id="card-2">
                            <header><span className="cube"></span>Mission</header>
                            <article>
                    ...
                    <div className="col-lg-4 col-sm-12 no-gutters">
                        <div className="mission-card" id="card-3">
                            <header><span className="cube"></span>Values</header>
                            <article>
